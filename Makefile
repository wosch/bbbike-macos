...
#
# $Id: Makefile,v 1.88 2009/04/12 21:22:25 wosch Exp $
...
build-perl-libs:
	yes "" | env PATH="/bin:/usr/bin" ${PERL_FAKEDIR}/${PERL_RELEASE}/bin/cpan -i CPAN
	yes "" | env PATH="/bin:/usr/bin" ${PERL_FAKEDIR}/${PERL_RELEASE}/bin/cpan -i YAML
