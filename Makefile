...
#
# $Id: Makefile,v 1.90 2009/04/12 21:37:11 wosch Exp $
...
build-perl-libs:
	yes "" | env PATH="/bin:/usr/bin" HOME=${PERL_FAKEDIR}/${PERL_RELEASE}/cpan ${PERL_FAKEDIR}/${PERL_RELEASE}/bin/cpan -i CPAN 
